...
var subHeaderTextStyle= GoogleFonts.roboto(color: AppColor.primaryColor,
    fontWeight: AppDimension.fontWeight500,
    fontSize: AppDimension.fontSizeMedium);
var h1TextStyle= GoogleFonts.roboto(color: AppColor.blackValueColor,
    fontWeight: AppDimension.fontWeight500,
    fontSize: AppDimension.fontSizeMedium);
var h2TextStyle= GoogleFonts.roboto(color: AppColor.unselectedTextColor,
...
var unSelectedTextStyleMedium=GoogleFonts.roboto(color: AppColor.unselectedTextColor,
    fontWeight: AppDimension.fontWeight400,
    fontSize: AppDimension.fontSizeMedium);
var formValueTextStyleMedium=GoogleFonts.roboto(color: AppColor.blackValueColor,
    fontWeight: AppDimension.fontWeight400,
    fontSize: AppDimension.fontSizeMedium);
